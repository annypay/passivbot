# 策略深度分析：`g4_account_guard_c1__ext`（Binance 永续 1 分钟 29.54 天回测）

## 口径与范围

- 本 arm：`c1__ext`（杠杆 `c1`，全历史腿（同一冻结 bundle 的 dataset override；包含搜索窗，只有 2021-05 崩盘段属于样本外））。搜索候选（max_adg）：TWE 2.80 / allowance 0.21 / n_pos 6 / RED 0.30 / EMA 75 / 停 72H
...
- 生效窗口：2021-04-20T00:00:00 → 2026-09-13T00:00:00（`analysis.json` 记录 2021-04-20T00:01:00Z → 2021-05-19T12:54:00Z）。
...
- 有效区间（UTC）：2021-04-20T00:01:00Z 至 2021-05-19T12:54:00Z；回测天数 29.54；数据完成度 1.50%。
...
| 项目 | 数值 |
| --- | --- |
| 结果目录 | backtests/binance/g4_twe300_risk_optimization_2026-09-17/artifacts/c1__ext/backtest_results/binance_c1__ext/binance/2026-09-18T00_05_45 |
...
- 生效区间 2021-04-20T00:01:00Z → 2021-05-19T12:54:00Z（声明窗口到 2026-09-13）；强平之后的行情与该账户无关。
...
- 冻结父配置：`backtests/binance/g4_sma20_50_replay_2026-09-16/artifacts/g4_sma20_50.config.json`（sha256 `5c8ab5edad9b571cab32a91e82013268ad99ff746a49131cb37bf225b2908bd9`）；本 arm 配置 `backtests/binance/g4_twe300_risk_optimization_2026-09-17/artifacts/g4_c1__ext.config.json`（sha256 `9ee01a8b9543b9c15722c3a8a460c57dbae43809d49b33ff9867dca14fa01415`）。
...
- 独立复算：`report_tools/verify_variant_report.py --variant c1__ext`（该脚本不 import 本渲染器，重算事件表、冲击矩阵、守护遥测与停机窗口）。
