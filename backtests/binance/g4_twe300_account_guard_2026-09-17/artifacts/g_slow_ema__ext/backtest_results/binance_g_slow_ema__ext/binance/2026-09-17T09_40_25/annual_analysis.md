# 策略深度分析：`g4_account_guard_g_slow_ema__ext`（Binance 永续 1 分钟 29.54 天回测）

## 口径与范围

- 本 arm：`g_slow_ema__ext`（杠杆 `g_slow_ema`，5.4 年历史压力腿（同一冻结 bundle 的 dataset override））。5.4 年腿：同阈值但 EMA 720（失效对照）
...
| 项目 | 数值 |
| --- | --- |
| 结果目录 | backtests/binance/g4_twe300_account_guard_2026-09-17/artifacts/g_slow_ema__ext/backtest_results/binance_g_slow_ema__ext/binance/2026-09-17T09_40_25 |
...
- 冻结父配置：`backtests/binance/g4_sma20_50_replay_2026-09-16/artifacts/g4_sma20_50.config.json`（sha256 `5c8ab5edad9b571cab32a91e82013268ad99ff746a49131cb37bf225b2908bd9`）；本 arm 配置 `backtests/binance/g4_twe300_account_guard_2026-09-17/artifacts/g4_g_slow_ema__ext.config.json`（sha256 `843c215f467421425fbf7392f98836a2e34d3734af8f512047eed2aaf9c104fd`）。
...
- 独立复算：`report_tools/verify_variant_report.py --variant g_slow_ema__ext`（该脚本不 import 本渲染器，重算事件表、冲击矩阵、守护遥测与停机窗口）。
