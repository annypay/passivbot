# 策略深度分析：`g4_account_guard_g_orange_only__ext`（Binance 永续 1 分钟 29.54 天回测）

## 口径与范围

- 本 arm：`g_orange_only__ext`（杠杆 `g_orange_only`，5.4 年历史压力腿（同一冻结 bundle 的 dataset override））。5.4 年腿：只在 −20% 停加仓（从不清仓）
...
| 项目 | 数值 |
| --- | --- |
| 结果目录 | backtests/binance/g4_twe300_account_guard_2026-09-17/artifacts/g_orange_only__ext/backtest_results/binance_g_orange_only__ext/binance/2026-09-17T09_39_57 |
...
| 处于 YELLOW / ORANGE / RED 的采样占比 | 0.1411% / 0.0188% / 0.0000% |
| 停机时长（均值 / 最长，分钟） | 0 / 0 |
...
- 冻结父配置：`backtests/binance/g4_sma20_50_replay_2026-09-16/artifacts/g4_sma20_50.config.json`（sha256 `5c8ab5edad9b571cab32a91e82013268ad99ff746a49131cb37bf225b2908bd9`）；本 arm 配置 `backtests/binance/g4_twe300_account_guard_2026-09-17/artifacts/g4_g_orange_only__ext.config.json`（sha256 `48ab1ece2c88ef5074d3924208ec71958319f7c4addb5b8ca667e7f528386e06`）。
...
- 独立复算：`report_tools/verify_variant_report.py --variant g_orange_only__ext`（该脚本不 import 本渲染器，重算事件表、冲击矩阵、守护遥测与停机窗口）。
