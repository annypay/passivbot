#!/usr/bin/env python3
"""Run one arm of the g4 @ TWE 3.0 / 10,000 USDT replay offline and write its provenance.
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_record = {
        "candidate_id": f"g4_twe300_10k_{variant.key}",
        "candidate_kind": "twe_scale_arm_replay",
        "variant": {
            "key": variant.key,
            "lever": variant.lever,
