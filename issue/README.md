...
| `0002-binance-live-debug-2026-09-17.md` | 币安实盘调试与上线：离线预检、公开数据门控探测、认证只读账户探测、实盘启动（待入金） | 进行中 | #6 | 2026-09-17 |
| `0003-g4-tail-risk-and-wipeout-2026-09-17.md` | g4 尾部风险研究：单币/多币归零的损失上界、HSL（coin/pside/unified）与结构性去风险的实测对照、预注册判据 J1–J4 的裁决 | 已完成（阶段 A） | #8 | 2026-09-17 |
| `0004-g4-twe300-10k-replay-2026-09-17.md` | TWE 3.0 / 10,000 USDT 重跑：强平事实（2021-05-19，存活 29.5 天）、硬底线 0 次触发、结构性去风险 vs 熔断的对照、10k 实盘准入 | 已完成 | #9 | 2026-09-17 |
| `0005-g4-twe300-account-guard-2026-09-17.md` | g4 @ TWE 3.0 账户级守护实测：一周 −20% 熔断 12H / 升级 24H 的生存与代价、软刹车被证伪（443 笔成交与无守护臂逐笔相同）、终局锁存陷阱、预注册判据 J1–J5 的裁决 | 已完成 | #10 | 2026-09-17 |
| `0007-g4-overfitting-audit-2026-09-18.md` | 跨轮次过拟合审计：把四轮研究在同一份 2021–2026 Binance 历史上做过的试验登记成台账（N 下界 1805），用 CSCV/PBO（两口径 × 四分块 + 预注册退化剔除）、DSR/MinBTL/平稳自助 SPA（N 敏感性 92/200/500/1807）、K=3/6 折叠稳定性与 45 个声明式成本压力臂量化「挑最好」的脆弱性；J1/J3/J4 样本外不通过 ⇒ J5 判定不冻结这条历史，只做机制性改动并把守护/阶梯标注样本外未确认 | 已完成 | #13 | 2026-09-18 |
| `0006-g4-twe300-risk-optimization-2026-09-17.md` | g4 @ TWE 3.0 风险几何优化：占用纪律（`we_excess_allowance_pct=0`）的实测、冷却档位为下一轮引擎阶梯定档、累计二档与实现亏损刹车、只搜风险几何的 pymoo 参数搜索 + 样本外验收、预注册判据 J1–J6 的裁决 | 已完成 | #11 | 2026-09-17 |
