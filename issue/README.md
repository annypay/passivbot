...
| `0007-g4-twe300-sl-cooldown-2026-09-18.md` | g4 @ TWE 3.0 单币止损：2026-06 ZEC 归因与乐观偏差审计、`bot.<pside>.stop_loss`（默认关闭）、30 臂 S0–S7 判定（含合成崩塌腿）、交易所侧常驻止损缺口 | 已完成（A/B/C） | 本轮 | 2026-09-18 |
