...
BOT_GROUP_FIELD_MAP = {
    "risk": {
        ...
        "wallet_exposure_brake_enabled": "risk_wallet_exposure_brake_enabled",
        "wallet_exposure_brake_start_drawdown": "risk_wallet_exposure_brake_start_drawdown",
        "wallet_exposure_brake_full_drawdown": "risk_wallet_exposure_brake_full_drawdown",
        "wallet_exposure_brake_min_scale": "risk_wallet_exposure_brake_min_scale",
