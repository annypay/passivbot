...
```shell
passivbot download configs/examples/default_trailing_martingale_long.json
...
`configs/examples/default_trailing_martingale_long.json`. Enable it only when you deliberately
